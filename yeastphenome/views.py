...
def get_latest_stats():
    ...
    g1 = Q(data_measured__rank__lt=F('data_published__rank'))   # datasets in need of data recovery
    g2 = Q(data_available__rank__lt=F('data_published__rank'))   # datasets with recovered data
